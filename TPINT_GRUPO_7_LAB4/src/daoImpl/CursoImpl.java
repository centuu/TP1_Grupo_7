...
public class CursoImpl implements CursoDao
{
	...
	private static final String list = "SELECT * FROM Cursos INNER JOIN materias ON materias.idMateria = cursos.idMateria INNER JOIN docentes ON docentes.nroLegajo = cursos.idDocente";
	...
	public ArrayList<Curso> list() {
        ...
        try
        {
        	...
        	while(rs.next())
        	{
        		...
        		profesor.setLegajo(rs.getString("nroLegajo"));
