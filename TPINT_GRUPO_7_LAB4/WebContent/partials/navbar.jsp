...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	<div class="container-fluid">
    	<a class="navbar-brand ms-5" href="inicio.jsp">Home</a>
    	...
    	<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mx-auto mb-2 mb-lg-0 ">
				...
				<%}
				    else if(session.getAttribute("rol").toString().equals("2"))
				    {
						...
						<li class="nav-item">
		          			<a class="nav-link" href="Docentes.jsp">Alumnos</a>
						</li>
				 <% }
			...
			<li class="nav-item">
				...
				<%}%>
		 	    	...
		 	    	{ %> 
		          		<a class="nav-link me-5 " href="login.jsp" style="display: inline;">LogIn</a>
		          <%} %>
		</div>
	</div>
</nav>